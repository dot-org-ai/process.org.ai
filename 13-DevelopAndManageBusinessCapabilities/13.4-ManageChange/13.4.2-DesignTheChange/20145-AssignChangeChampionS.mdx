...
> Business-as-Code definition for assign change champion(s). Models the process of utilizing champions that have been trained to carry out needed changes.
...
```typescript
import { assignChangeChampions } from '@headlessly/assign-change-champions'

const client = assignChangeChampions()
