...
> Business-as-Code definition for analyze data. Models the process of conducting data analysis.
...
```typescript
import { analyzeData } from '@headlessly/analyze-data'

const client = analyzeData()
