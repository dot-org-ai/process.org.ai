...
> Business-as-Code definition for manage materials master lists. Models managing product and service master data governance, storage, and access control.
...
```mermaid
graph TD
    A[Manage materials master lists]
...
```typescript
import { manageMaterialsMasterLists } from '@headlessly/manage-materials-master-lists'

const client = manageMaterialsMasterLists()
