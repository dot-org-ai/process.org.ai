...
> Business-as-Code definition for manage bills of material. Models managing product and service master data governance, storage, and access control.
...
```typescript
import { manageBillsOfMaterial } from '@headlessly/manage-bills-of-material'

const client = manageBillsOfMaterial()
