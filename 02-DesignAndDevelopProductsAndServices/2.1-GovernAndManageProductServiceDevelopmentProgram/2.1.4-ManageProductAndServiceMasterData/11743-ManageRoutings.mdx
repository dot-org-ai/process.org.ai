...
> Business-as-Code definition for manage routings. Models managing product and service master data governance, storage, and access control.
...
```typescript
import { manageRoutings } from '@headlessly/manage-routings'

const client = manageRoutings()
