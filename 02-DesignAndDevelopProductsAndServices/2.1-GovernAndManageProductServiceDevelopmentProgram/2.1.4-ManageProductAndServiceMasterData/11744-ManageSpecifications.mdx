...
> Business-as-Code definition for manage specifications. Models managing product and service master data governance, storage, and access control.
...
```typescript
import { manageSpecifications } from '@headlessly/manage-specifications'

const client = manageSpecifications()
