...
> Business-as-Code definition for manage drawings. Models managing product and service master data governance, storage, and access control.
...
```mermaid
graph TD
    A[Manage product and service master data] --> B[Manage materials master lists]
...
```typescript
import { manageDrawings } from '@headlessly/manage-drawings'

const client = manageDrawings()
