...
level: Task
verb: 'Define'
object: 'Basic Functional Requirements'
...
> Business-as-Code definition for define basic functional requirements. Models defining product and service development requirements including functional, safety, regulatory, and user experience specifications.
...
```mermaid
graph TD
    A[Define basic functional requirements]
...
```typescript
import { defineBasicFunctionalRequirements } from '@headlessly/define-basic-functional-requirements'

const client = defineBasicFunctionalRequirements()
