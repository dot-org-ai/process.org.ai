...
> Business-as-Code definition for design for manufacturing. Models designing and prototyping products and services, from business case preparation through prototype testing and supplier collaboration.
...
```typescript
import { designForManufacturing } from '@headlessly/design-for-manufacturing'

const client = designForManufacturing()
