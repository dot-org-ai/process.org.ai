...
> Business-as-Code definition for design for product servicing. Models designing and prototyping products and services, from business case preparation through prototype testing and supplier collaboration.
...
```mermaid
graph TD
    A[Design for product servicing]
...
```typescript
import { designForProductServicing } from '@headlessly/design-for-product-servicing'

const client = designForProductServicing()
