...
> Business-as-Code definition for design for re-manufacturing. Models designing and prototyping products and services, from business case preparation through prototype testing and supplier collaboration.
...
```typescript
import { designForRemanufacturing } from '@headlessly/design-for-re-manufacturing'

const client = designForRemanufacturing()
