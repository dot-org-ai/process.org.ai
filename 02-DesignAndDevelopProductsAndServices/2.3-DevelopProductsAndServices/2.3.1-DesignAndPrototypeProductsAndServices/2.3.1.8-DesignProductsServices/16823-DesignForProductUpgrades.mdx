...
> Business-as-Code definition for design for product upgrades. Models designing and prototyping products and services, from business case preparation through prototype testing and supplier collaboration.
...
```typescript
import { designForProductUpgrades } from '@headlessly/design-for-product-upgrades'

const client = designForProductUpgrades()
