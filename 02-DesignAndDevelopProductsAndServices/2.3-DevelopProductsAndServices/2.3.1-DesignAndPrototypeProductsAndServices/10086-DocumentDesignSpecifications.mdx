...
> Business-as-Code definition for document design specifications. Models designing and prototyping products and services, from business case preparation through prototype testing and supplier collaboration.
...
```mermaid
graph TD
    A[Document design specifications]
...
```typescript
import { documentDesignSpecifications } from '@headlessly/document-design-specifications'

const client = documentDesignSpecifications()
