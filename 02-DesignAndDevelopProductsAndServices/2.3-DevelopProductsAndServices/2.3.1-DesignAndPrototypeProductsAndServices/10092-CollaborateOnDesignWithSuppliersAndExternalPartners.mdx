...
level: Activity
verb: 'Collaborate'
object: 'On Design With Suppliers And External Partners'
...
> Business-as-Code definition for collaborate on design with suppliers and external partners. Models designing and prototyping products and services, from business case preparation through prototype testing and supplier collaboration.
...
```mermaid
graph TD
    A[Collaborate on design with suppliers and external partners]
...
```typescript
import { collaborateOnDesignWithSuppliersAndExternalPartners } from '@headlessly/collaborate-on-design-with-suppliers-and-external-partners'

const client = collaborateOnDesignWithSuppliersAndExternalPartners()
