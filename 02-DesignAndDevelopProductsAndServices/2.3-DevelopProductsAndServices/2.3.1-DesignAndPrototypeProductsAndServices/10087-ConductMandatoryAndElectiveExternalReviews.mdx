...
level: Activity
verb: 'Conduct'
object: 'Mandatory And Elective External Reviews'
...
> Business-as-Code definition for conduct mandatory and elective external reviews. Models designing and prototyping products and services, from business case preparation through prototype testing and supplier collaboration.
...
```mermaid
graph TD
    A[Conduct mandatory and elective external reviews]
...
```typescript
import { conductMandatoryAndElectiveExternalReviews } from '@headlessly/conduct-mandatory-and-elective-external-reviews'

const client = conductMandatoryAndElectiveExternalReviews()
