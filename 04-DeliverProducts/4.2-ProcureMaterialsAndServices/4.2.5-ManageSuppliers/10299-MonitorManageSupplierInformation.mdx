...
> Business-as-Code definition for monitor/manage supplier information. Models the supplier-performance processes within procurement to ensure materials and services are acquired efficiently and cost-effectively.
...
```mermaid
graph TD
    A[Manage suppliers] --> B[Monitor/Manage supplier information]
...
monitorAndManage:
  ...
  result: SupplierInformationMonitored
```
...
| Action | Description |
|--------|-------------|
| monitorSupplierInfo | Monitor supplier information based on organizational requirements |
...
| executeAction | Carry out monitor/manage supplier information tasks and document outcomes |
...
| actionExecuted | Monitor/Manage supplier information tasks completed and documented |
...
| Search | Description |
|--------|-------------|
| getProcurementStatus | Retrieve current status of monitor/manage supplier information activities |
...
| getProcurementHistory | Query historical data for supplier information activities |
...
|-----|-------------|------|
| Procurement Cycle Time | Average time to complete monitor/manage supplier information | Days |
...
```typescript
import { monitorManageSupplierInformation } from '@headlessly/monitor-manage-supplier-information'

const client = monitorManageSupplierInformation()
