...
> Business-as-Code definition for release production orders and create lots. Models the scheduling activities within manufacturing to ensure efficient and compliant production operations.
...
```mermaid
graph TD
    A[Schedule production] --> B[Release production orders and create lots]
...
| Action | Description |
|--------|-------------|
| releaseActivity | Release production orders and create lots per established procedures |
| reviewInputs | Assess required inputs and prerequisites for release production orders and create lots |
...
| Event | Description |
|-------|-------------|
| inputsReviewed | Inputs and prerequisites assessed for release production orders and create lots |
...
| Search | Description |
|--------|-------------|
| getProductionStatus | Retrieve current status of release production orders and create lots activities |
...
| Production Cycle Time | Average time to complete release production orders and create lots | Hours |

## Usage

```typescript
import { releaseProductionOrdersAndCreateLots } from '@headlessly/release-production-orders-and-create-lots'

const client = releaseProductionOrdersAndCreateLots()
